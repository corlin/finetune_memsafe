#!/usr/bin/env python3
"""
使用ONNX opset版本20的模型导出脚本

测试opset版本20是否能解决导出问题
"""
...
def main():
    """主函数"""
    print("🚀 Qwen3模型导出工具 (ONNX opset版本20)")
    print("=" * 50)
    ...
    try:
        ...
        print("导出格式: PyTorch + ONNX (opset版本20)")
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(f"logs/qwen3_export_opset20_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log", encoding='utf-8')
    ]
)

# 创建导出配置 - 使用ONNX opset版本20
config = ExportConfiguration(
    checkpoint_path="./qwen3-finetuned/checkpoint-30",
    base_model_name="Qwen/Qwen3-4B-Thinking-2507",
    output_directory="./exported_models/qwen3_opset20",
...
'''
        ...
        print("\n🎉 导出完成！")
        print("\n下一步:")
        print("1. 查看 ./exported_models/qwen3_opset20/ 目录中的导出文件")
